...
class QuestionRepositoryTest {
    ...
    void sameIdUpdate() {
        ...
        //when
        Question updateQuestion = new Question(saved.getId(), SHORT_ANSWER, "전공", "전공을 입력해주세요.", 1, null);
    ...
    void saveNoId() {
        //given
        Question question1 = new Question(DROPDOWN, "성별", "성별을 선택해주세요.", 0, null);
        Question question2 = new Question(SHORT_ANSWER, "전공", "전공을 입력해주세요.", 1, null);
